        ...
        if ($typesend == 'addpgw') {
            ...
            $validation = [
                ...
                [
                    ...
                    'errors' => ['required' => 'You must provide a %s.', 'xss_clean' => 'Please check your form on %s.', 'is_unique' => 'NIK ini telah terdaftar didatabase!']
                ],
                [
                ...
                [
                    'field' => 'npwp_pegawai',
                    'label' => 'Status',
                    'rules' => 'required|xss_clean|in_list[THL,Kontrak]',
                    'errors' => ['required' => 'You must provide a %s.', 'xss_clean' => 'Please check your form on %s.']
                ],
                [
                    'field' => 'role_pegawai',
