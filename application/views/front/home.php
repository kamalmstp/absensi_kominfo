                    ...
                    <div class="row detail">
                        ...
                        <div class="col-md-10 col-sm-8 col-6">
                            <dl class="row">
                                ...
                                <dt class="col-sm-5">Status Kerja:</dt>
        ...
        <div class="col-xl-5">
            <div class="card mb-4">
                ...
                <div class="card-body text-center">
                    ...
                    <div>
                        <input type="hidden" name="ket_absen" id="ket_absen" value="Bekerja Di Kantor">
                    </div>
                    <div class="mt-2">
                        <div id="func-absensi">
                            <p class="font-weight-bold">Status Kehadiran: <?= $statuspegawai = (empty($dbabsensi['status_pegawai'])) ? '<span class="badge badge-primary">Belum Absen</span>' : (($dbabsensi['status_pegawai'] == 1) ? '<span class="badge badge-success">Sudah Absen</span>' : '<span class="badge badge-danger">Absen Terlambat</span>'); ?>
                                <?php 
                                if ((empty($dbabsensi['status_pegawai']))) {
                                    echo "-";
                                }else{
                                $masuk = strtotime($dbabsensi['jam_masuk']);
                                $mulai = strtotime($dataapp['absen_mulai']);
