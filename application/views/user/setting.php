                ...
                <div class="card-body">
                    <div class="tab-content mt-3">
                        <div class="tab-pane active" id="setelan" role="tabpanel">
                            ...
                            <div class="form-group row">
                                <label for="username_pegawai" class="col-sm-4 col-form-label">NIK</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label for="npwp_pegawai" class="col-sm-4 col-form-label">Status</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="npwp_pegawai" name="npwp_pegawai" value="<?= $user['npwp']; ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
