    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <label for="username_pegawai" class="col-sm-4 col-form-label">NIK Pegawai</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group row">
                    <label for="npwp_pegawai" class="col-sm-4 col-form-label">Status Pegawai</label>
                    <div class="col-sm-8">
                        <div class="form-check form-check-inline">
                            <?= form_radio('npwp_pegawai', 'THL', set_radio('npwp_pegawai[]', 'THL'), "id='npwp_pegawai' class='form-check-input'"); ?>
                            <label class="form-check-label" for="npwp_pegawai1">THL</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <?= form_radio('npwp_pegawai', 'Kontrak', set_radio('npwp_pegawai[]', 'Kontrak'), "class='form-check-input'"); ?>
                            <label class="form-check-label" for="npwp_pegawai2">Kontrak</label>
                        </div>
                    </div>
                </div>
                <!-- <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <?= form_dropdown('role_pegawai', ['' => 'Select Role', 1 => 'Administrator', 3 => 'Pegawai'], set_value('role_pegawai'), 'class="form-control" id="role_pegawai"'); ?>
                    </div>
                </div>
                <div class="form-group row">
